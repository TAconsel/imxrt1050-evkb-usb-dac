...
#endif
/* USB side: 48 kHz / 32-bit / 2 ch. The WM8960 DAC is 24-bit internally,
 * so the low 8 bits of each 32-bit subslot are discarded by the codec. */
#define AUDIO_FORMAT_BITS (32)
